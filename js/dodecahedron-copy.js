...
var canvas_middle = "canvas-middle"
var canvas_right = "canvas-right"

var img1 = "./images/textures/texture.png"
var img2 = "./images/textures/texture.jpg"
var img3 = "./images/textures/texture.png"


function startAllGL()
{
    // startGL(canvas_left)
    // startGL(canvas_middle)
    startGL(canvas_right)
}


function startGL(canvas_name) 
{
  //alert("StartGL");
  let canvas = document.querySelector(canvas_name); //wyszukanie obiektu w strukturze strony 
 ...
 console.log(vertexCoords.length);
  ...
  textureImg.src = img1; //Nazwa obrazka
  ...
  textureImg2.src = img2; //Nazwa obrazka
