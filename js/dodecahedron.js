...
function initBuffers()
{
    ...
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(dodecahedronPosition), gl.STATIC_DRAW)
    vertexPositionBuffer.itemSize = 3
    vertexPositionBuffer.numItems = dodecahedronPosition.length;

    vertexCoordsBuffer = gl.createBuffer()
    gl.bindBuffer(gl.ARRAY_BUFFER, vertexCoordsBuffer)
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(dodecahedronCoords), gl.STATIC_DRAW)
...
function render()
{
    ...
    gl.uniformMatrix4fv(gl.getUniformLocation(shaderProgram, "projectionMatrix"), false, new Float32Array(uPMatrix)); //Wgranie macierzy kamery do pamięci karty graficznej
